                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">
                                        ...
                                        </a>Administración de Hojas de Ruta Familia
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php include "modal_create_hoja_familia.php"; ?>
                                    ...
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Registrar Evento en la Hoja de Ruta Familia</h4>
                                            </div>
                                ...
                                <div id="modal_editar_hoja" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                <h4 class="modal-title" id="myModalLabel">Actualizar Hoja de Ruta Familia</h4>
                                            </div>
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", ".btnEditarHoja", function() {
                    ...
                    $.ajax({
                        ...
                        success: function(r) {
                                if(r) {
                                    $('#editar_hoja').load('modal_update_hoja_familia.php');
                ...
                $('#update_hoja').click(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            if(response){
                                $('#tabla_hoja').load('tabla_hoja_familia_serverside.php');
                ...
                //CARGAMOS TODAS LAS HOJAS DE RUTA DE FAMILIA
                $('#tabla_hoja').load('tabla_hoja_familia_serverside.php');
