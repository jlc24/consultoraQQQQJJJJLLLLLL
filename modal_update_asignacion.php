    ...
    <?php 
        if ($adm['adm_rol'] == 'admin') { ?>
            <form class="form-horizontal" id="formulario_crear_asignacion" class="parsley_create_hoja" novalidate="">
                ...
                <div class="form-group row">
                    <div class="col-md-12" id="tabla_asignar_area_update">
        ...
        <?php
            ...
            <form class="form-horizontal" id="formulario_crear_asignacion" >
                ...
                <table class="table table-sm table-striped table-bordered dt-responsive">
                    ...
                    <tbody> <?php
                        $sql1 = "SELECT proceso.proceso_id, proceso_nombre, asig_estado FROM asignacion, proceso WHERE asignacion.proceso_id = proceso.proceso_id AND adm_id = (SELECT adm_id FROM configuracion);";
    ...
    <script>
        $("#qjl_area").change(function(){
            var area = "area_id=" + $("#qjl_area").val()+"&adm_id="+$("#qjl_adm_id").val();
            ...
            $.ajax({
                ...
                success: function(r) {
                    if(r) {
                        $('#tabla_asignar_area_update').load('tabla_asignar_area_update.php');
                    }
                }
            })
        })
