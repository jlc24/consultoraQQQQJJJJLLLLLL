        ...
        <script type="text/javascript">
            $(document).ready(function (){
                var table = $('#ventaAnual').dataTable({
        ...
        <div class="table-responsive">
            <table id="ventaAnual" class="table table-background table-background-dark table-hover table-condensed dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                    ...
                    $sql="SELECT fac_id, fac_fecha_hora, fac_nombre_cliente, fac_nombre_usuario, fac_total, fac_utilidad, fac_importe, fac_cambio FROM factura WHERE year(fac_fecha_hora) = '$year'";
