        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Registrar Hoja de Ruta A.I.T.</h4>
                </div>
                        ...
                        <legend style="display: none;">Datos del Cliente</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 input-group">
                                    ...
                                    <input type="hidden" class="form-control form-control-md" id="area_proceso" name="area_proceso" value="A.I.T.">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="hoja_actor_cliente" name="hoja_actor_cliente" class="form-control form-control-md" value="RECURRENTE" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label ui-front">Autoridad Recurrida</label>
                                <div class="col-md-8">
                        ...
                        <legend style="display: none;">Datos del Caso</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    value="<?php $fila = mysqli_fetch_row(mysqli_query($conexion,"SELECT COUNT(*) FROM hoja WHERE hoja_area_proceso = 'AIT';"));
                                    $numero_hoja_ruta = (int)$fila[0]+1; echo 'QJAIT-'.$numero_hoja_ruta ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">Nº de Expediente</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">Tipo de Recurso</label>
                                <div class="col-md-8">
                                    <select class="custom-select custom-select-sm" id="hoja_tipo_delito" name="hoja_tipo_delito">
                                        <option selected="">---- SELECCIONAR ----</option>
                                        <option value="ALZADA">ALZADA</option>
                                        <option value="JERARQUICO">JERARQUICO</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row" hidden>
