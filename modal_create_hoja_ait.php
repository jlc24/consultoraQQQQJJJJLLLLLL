                                            ...
                                            <legend style="display: none;">Datos del Cliente</legend>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 input-group">
                                                        ...
                                                        <input type="hidden" class="form-control form-control-md" id="area_proceso" name="area_proceso" value="AIT">
                                            ...
                                            <legend style="display: none;">Datos del Caso</legend>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        $numero_hoja_ruta = (int)$fila[0]+1; echo 'QJAIT-'.$numero_hoja_ruta ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
