        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                //alert(versionNo);
                var table = $('#tasignada').DataTable();
                $('#tasignada_filter input').focus();
            });
        </script>
        ...
        <table id="tasignada" class="table mb-0 table-sm table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
                ...
                $sql = "SELECT `det_id`,`hoja_numero_tramite`,`hoja_demandante`,`hoja_demandado`,`hoja_patrocinio`,
                        ...
                        WHERE hoja_detalle.hoja_id = hoja.hoja_id AND det_estado = 'EJECUCION' AND NOW() < det_fin AND det_encargado = '".$admid."';";
