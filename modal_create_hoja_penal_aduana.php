        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Registrar Hoja de Ruta Penal Aduanero</h4>
                </div>
                    ...
                    <form id="formulario_crear_hoja" action="#" class="parsley_create_hoja" novalidate="">
                        ...
                        <legend style="display: none;">Datos del Cliente</legend>
                            <div class="form-group row">
                                ...
                                <input type="hidden" class="form-control form-control-md" id="area_proceso" name="area_proceso" value="PENAL ADUANERO">
                        ...
                        <legend style="display: none;">Datos del Caso</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    value="<?php $fila = mysqli_fetch_row(mysqli_query($conexion,"SELECT COUNT(*) FROM hoja WHERE hoja_area_proceso = 'PENAL ADUANERO';"));
                                    $numero_hoja_ruta = (int)$fila[0]+1; echo 'QJPA-'.$numero_hoja_ruta ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">CUD</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">Delito</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label">Juzgado de Instrucción Penal </label>
                                <div class="col-md-8">
