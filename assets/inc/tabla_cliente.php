                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            { 
                            ?>
                                <a style="color:black;" href="<?php echo 'https://web.whatsapp.com/send?phone=591' . $registro["cli_celular"]; ?>" target="_blank" title="Enviar SMS por WhatsApp">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal_actualizar_cliente" onclick="EditarCliente('<?php echo $datos; ?>')">
                                        <i class="far fa-edit"></i>
                                        <span>Editar</span>
                                    </a>
                                    <a class="dropdown-item" href="#" onclick="EliminarCliente('<?php echo $registro["cli_id"] . "||" . $registro["cli_nombre"]; ?>')">
