        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                //alert(versionNo);
                var table = $('#pendiente_adm').DataTable();
                $('#pendiente_adm_filter input').focus();
            });
        </script>
        ...
        <table id="pendiente_adm" class="table mb-0 table-sm table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
                ...
                $sql = "SELECT `det_id`,`hoja_numero_tramite`,`hoja_demandante`,`hoja_demandado`,`hoja_patrocinio`,
                        ...
                        WHERE hoja_detalle.hoja_id = hoja.hoja_id AND det_estado = 'EJECUCION' ORDER BY det_fin DESC;";
