        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Registrar Hoja de Ruta Administrativo</h4>
                </div>
                        ...
                        <legend style="display: none;">Datos del Cliente</legend>
                            ...
                            <div class="form-group row">
                                ...
                                <select class="custom-select custom-select-sm" id="hoja_actor_cliente" name="hoja_actor_cliente" onchange="verificarCliente()">
                                        ...
                                        <option value="DEMANDANTE">DENUNCIANTE</option>
                                        <option value="DEMANDADO">DENUNCIADO</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <legend style="display: none;">Datos del Caso</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    value="<?php $fila = mysqli_fetch_row(mysqli_query($conexion,"SELECT COUNT(*) FROM hoja WHERE hoja_area_proceso = 'ADMINISTRATIVO';"));
                                    $numero_hoja_ruta = (int)$fila[0]+1; echo 'QJADM-'.$numero_hoja_ruta ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
