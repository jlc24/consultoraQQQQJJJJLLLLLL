<?php
    ...
    $sql = "SELECT COUNT(*) FROM nota WHERE  adm_id = '".$_SESSION['adm_id']."';";
    ...
    if ($total == '0') { ?>
        ...
        <button class="btn btn-light btn-circle" type="button" data-toggle="dropdown" title="Mensajes Leidos" style="width: 50px; height: 50px; padding: 7px 10px; margin-top: 10px; border-radius: 50%;">
            <i class="noti-icon fas fa-paper-plane" style="font-size: 30px; color: #DC5C05;"></i>
        </button>
        <div class="dropdown-menu dropdown-menu-right dropdown-lg">
            <div class="dropdown-header noti-title">
                <h5 class="text-overflow m-0"><span class="float-right"></span>Mensajes enviados</h5>
            </div>
    ...
    <?php
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-lg">
            ...
            <div class="slimscroll noti-scroll" style="overflow-y: scroll;">
                <?php
                $sql1 = "SELECT * FROM nota WHERE adm_id = '".$_SESSION['adm_id']."' ORDER BY not_fecha_reg DESC;";
                            ...
                            <tr>
                                ...
                                <td style="width: auto;">
                                    <a class="dropdown-item notify-item btnVerMensaje" href="javascript:void(0);" >
                                        ...
                                        <p class="notify-details text-truncate" ><?php 
                                            $sql2 = "SELECT adm_nombre FROM administrador WHERE adm_id = '".$registro['not_destino']."';";
