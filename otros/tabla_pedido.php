        ...
        <table id="inventario" class="table mb-0 table-sm table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            <thead style="background-color: #DBEDC8;">
                ...
                <th data-priority="7">Stock Mínimo</th>
            ...
            <tbody>
                ...
                /*$sql = "SELECT * FROM producto WHERE prod_stock <= prod_stock_minimo AND prod_nicklaboratorio LIKE '$nombre_lab'";*/ //TODAVIA NO TIENE DATOS DE STOCKS MINIMOS, POR ESO NO ESO USA LA CONSULTA COMENTADA
                ...
                <tr>
                    ...
                    <td style="color:red;"><?php echo $registro['prod_stock']; ?></td>
                    <td><?php echo $registro['prod_stock_minimo']; ?></td>
