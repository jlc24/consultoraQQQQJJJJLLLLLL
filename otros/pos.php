                                    ...
                                    <form id="formulario_buscar_producto">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control search" id="producto" placeholder="Buscar por Nombre, Categoría Terapéutica, Principio Activo ó Código de Barras" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                ...
                                <div>
                                    <form id="formulario_crear_factura">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                <label class="col-form-label">Saldo Virtual</label>    
                                                <input type="number" class="form-control" id="fac_saldo_billetera_inmutable" name="fac_saldo_billetera_inmutable" readonly="">
                                                <label class="col-form-label">Saldo Virtual</label>
                                                <input type="number" class="form-control" id="fac_saldo_billetera" name="fac_saldo_billetera" readonly="">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="col-form-label">Utilidad de Venta</label>
                                                <input type="number" class="form-control" id="fac_utilidad_venta" name="fac_utilidad_venta" 
                                                    value="<?php $consulta = "SELECT SUM(det_utilidad) FROM detalle_factura WHERE fac_id = (SELECT MAX(fac_id) FROM factura)";
                                                    $fila = mysqli_fetch_row(mysqli_query($conexion,$consulta));
                                                    echo number_format((float)$fila[0], 2, '.', ''); ?>" readonly="">
                                                <label class="col-form-label">Importe Virtual</label>
                                                <input type="number" class="form-control" min="0" max="" step="0.1" id="fac_importe_virtual" name="fac_importe_virtual" value="0.00">
                                            </div>
                                            ...
                                            <div class="form-group col-sm-6">
                                                <label class="col-form-label">Total (Bs.)</label>
                                                <!--======================================
                                            ...
                                            <div class="form-group col-sm-6">
                                                <label class="col-form-label">Importe Virtual</label>
                                                <input type="number" min="0" class="form-control" id="fac_importe_virtual_pago" name="fac_importe_virtual_pago" value="0.00">
                                            </div>
                                            <div class="form-group col-sm-6">
            ...
            // CARGAMOS LA TABLA DETALLE DE LA FACTURA, EL NUMERO DE FACTURA Y EL TOTAL DE LA FACTURA.
                ...
                $("#producto").autocomplete({
                    ...
                    select: function(event, ui) {
                        ...
                        $('#prod_caducidad').val(ui.item.vencimiento);
                    ...
                    .append("<div class='acItem'><span class='name'>"+item.vencimiento+"</span>"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"<span class='name'>"+item.laboratorio+"</span>"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"<span class='name'>"+item.codigo+"</span><span class='name'>"+ "&nbsp;&nbsp;&nbsp;&nbsp;" + item.nombre+"</span><br><span class='desc'>"+item.forma+"</span>"+ ",&nbsp;&nbsp;" +"<span class='desc'>"+item.propaganda+"</span><br><span class='desc'>"+item.ingrediente+"</span></div>")
                    .appendTo( ul );
                };
            ...
            =========================================================================-*/
                $("#fac_ci_nit").autocomplete({
                    ...
                    select: function(event, ui) {
                        ...
                        $('#fac_saldo_billetera').val(ui.item.billetera);
                        $('#fac_saldo_billetera_inmutable').val(ui.item.billetera);
                        $("#fac_importe_virtual").val(0);
                        $("#fac_importe_virtual").attr({"max" : ui.item.billetera});
                    }
                });
                //Cambiamos el valor de Saldo virtual y modificar el valor de importe virtual
                $('#fac_importe_virtual').on('click keyup change', function(){
                    var valor = (parseFloat( $('#fac_saldo_billetera_inmutable').val()) - parseFloat($("#fac_importe_virtual").val())).toFixed(2);
                    //alert(valor);
                    $('#fac_saldo_billetera').val(valor);
                    $('#fac_importe_virtual_pago').val(parseFloat($("#fac_importe_virtual").val()));
                    var valor_virtual = parseFloat($("#fac_importe_virtual").val());
                    if(valor_virtual > 0){
                        $('#fac_forma_pago option[value=MIXTO]').attr('selected',true);
                    }
                    else{
                        //$("#fac_forma_pago option:selected").remove();
                        $('#fac_forma_pago option[value=CONTADO]').attr('selected',true);
                    }
                });
