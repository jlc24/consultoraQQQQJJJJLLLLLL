    ...
    <body>
                                    ...
                                    <div class="table-responsive">
                                        <table id="productoDisponible" class="table mb-0 table-sm table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                ...
                                                <th data-priority="7">Caducidad</th>
                                    ...
                                    <form id="formulario_crear_factura">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <input type="text" class="form-control" readonly="" id="fac_cambio" name="fac_cambio" value="0.00">
                                            </div>
                                        </div>
                                        <div class="form-row">
        ...
        <script type="text/javascript">
            ...
            // CARGAMOS LA TABLA DETALLE DE LA FACTURA, EL NUMERO DE FACTURA Y EL TOTAL DE LA FACTURA.
                ...
                $('#producto').focus();
                //CARGAMOS LA TABLA PRODUCTOS REGISTRADOS
                //$('#tabla_tpv').load('tabla_tpv.php');
            ...
            =========================================================================-*/
                ...
                $('#create_factura').click(function(){
                    ...
                    if($('#fac_total').val() === 0) { //SI EL TOTAL ES CERO
                        Swal.fire({
                    ...
                    if($('#fac_nombre').val() == "") { //SI LA FACTURA NO TIENE NOMBRE DEL CLIENTE
                        Swal.fire({
                    ...
                    if($('#fac_total').val() > 0 && $('#fac_nombre').val() != ""){//SI EL TOTAL ES MAYOR A CERO, Y EL NOMBRE DEL CLIENTE NO ESTA VACIO
