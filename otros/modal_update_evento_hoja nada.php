            ...
            ?>
                ...
                <form class="form-horizontal" id="formulario_editar_evento_hoja">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="detalle_etapa" name="detalle_etapa" class="form-control form-control-md" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $row['det_etapa'];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">Acciones</label>
                        <div class="col-md-8">
                            <textarea class="form-control" rows="2" id="detalle_accion" name="detalle_accion" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"><?php echo $row['det_accion'];?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="datetime-local" id="detalle_fin" name="detalle_fin" class="form-control form-control-sm" value="<?php echo $row['det_fin'];?>">
                        </div>
                    </div>
                    <?php 
                    if ($row['det_audiencia'] == '0000-00-00 00:00:00') { 
                     ...
                     <div class='form-group row'>
                        ...
                        <div class='col-md-8'>
                            <input type='datetime-local' id='detalle_audiencia' name='detalle_audiencia' class='form-control form-control-sm'>
                        </div>
                    </div>"; ?>
                    <?php
                    } else {
                    ...
                    <div class="form-group row">
                       <label class="col-md-4 col-form-label">Fecha Audiencia</label>
                       <div class="col-md-8">
                           <input type="datetime-local" id="detalle_audiencia" name="detalle_audiencia" class="form-control form-control-sm" value="<?php echo $row['det_audiencia'];?>">
                       </div>
                   </div>
                   <?php
                    }
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label">Observación akuwjsbj</label>
                        <div class="col-md-8">
                            <textarea class="form-control" rows="3" id="detalle_observacion" name="detalle_observacion" style="text-transform: uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"><?php echo $row['det_observacion'];?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
