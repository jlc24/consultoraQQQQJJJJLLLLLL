        <!-- INICIALIZAMOS EL PLUGIN Datatables EN LA TABLA CON id=detalle_boleta-->
        <script type="text/javascript">
            $(document).ready(function() {
                $('#detalle_boleta').dataTable({
                    "paging": false,
                    "searching": false,
                    "info": false,
                    "oLanguage": {
        ...
        <div class="col-sm-12">
            <div class="table-responsive">
                <table id="detalle_boleta" class="table mb-0 table-sm dt-responsive" width="100%">
                    <thead>
                        <th>Cod.</th>
                        <th>Producto</th>
                        <th>Cantidad</th>
