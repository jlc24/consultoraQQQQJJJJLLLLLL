                        ...
                        <legend style="display: none;">Datos del Cliente</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 input-group">
                                    ...
                                    <input type="hidden" class="form-control form-control-md" id="area_proceso" name="area_proceso" value="PENAL">
                        ...
                        <legend style="display: none;">Datos del Caso</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    value="<?php $fila = mysqli_fetch_row(mysqli_query($conexion,"SELECT COUNT(*) FROM hoja WHERE hoja_area_proceso = 'PENAL';"));
                                    $numero_hoja_ruta = (int)$fila[0]+1; echo 'QJP-'.$numero_hoja_ruta ?>" readonly>
