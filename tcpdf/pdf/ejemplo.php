...
class ImprimirReporte
{
    ...
    {
        $stmt = Conexion::Conectar()->prepare("SELECT *from detalle_factura WHERE fac_id = 419");
        $stmt->execute();
...
//$pdf->reFormat("custom", $orientation);  
        ...
        $pageLayout = array(74, 105); //  or array($height, $width) 
...
<table border="0" style="font-size:10px; padding:3px 5px; border-collapse: collapse; border-radius:10px" >
    <tr>
        <th colspan="2" ></th>
        <th colspan="8" ><strong>AREA:</strong> CIENCIAS NATURALES </th>
