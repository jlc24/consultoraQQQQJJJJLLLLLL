...
class ImprimirReporte
{
	...
	{
		$stmt = Conexion::Conectar()->prepare("SELECT *FROM calificacion2021 WHERE cal_curso = '1A' AND cal_materia = 'LEN' AND cal_trimestre  = '3'");
		$stmt->execute();
...
<table border="0" style="font-size:10px; padding:3px 5px; border-collapse: collapse; border-radius:10px" >
	<tr>
		<th colspan="2" ></th>
		<th colspan="8" ><strong>AREA:</strong> COMUNICACIÓN Y LENGUAJE </th>
