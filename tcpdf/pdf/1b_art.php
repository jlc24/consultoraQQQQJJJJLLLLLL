...
class ImprimirReporte
{
	...
	{
		$stmt = Conexion::Conectar()->prepare("SELECT *FROM calificacion2021 WHERE cal_curso = '1B' AND cal_materia = 'ART' AND cal_trimestre  = '3'");
		$stmt->execute();
...
<table border="0" style="font-size:10px; padding:3px 5px; border-collapse: collapse; border-radius:10px" >
	<tr>
		<th colspan="2" ></th>
		<th colspan="8" ><strong>AREA:</strong> ARTES PLÁSTICAS Y VISUALES </th>
		<th colspan="9" ><strong>DOCENTE:</strong> ZEGARRA GONZALES DIONICIA </th>
	</tr>
	<tr>
		<th colspan="2" ></th>
		<th colspan="8" ><strong>CURSO:</strong> PRIMERO "B" </th>
