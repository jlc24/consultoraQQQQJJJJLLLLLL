        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Registrar Hoja de Ruta Aduana</h4>
                </div>
                        ...
                        <legend style="display: none;">Datos del Cliente</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 input-group">
                                    ...
                                    <input type="hidden" class="form-control form-control-md" id="area_proceso" name="area_proceso" value="ADUANA">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="hoja_actor_cliente" name="hoja_actor_cliente" class="form-control form-control-md" value="ADMINISTRADO" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <legend style="display: none;">Datos del Caso</legend>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    value="<?php $fila = mysqli_fetch_row(mysqli_query($conexion,"SELECT COUNT(*) FROM hoja WHERE hoja_area_proceso = 'ADUANA';"));
                                    $numero_hoja_ruta = (int)$fila[0]+1; echo 'QJA-'.$numero_hoja_ruta ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
